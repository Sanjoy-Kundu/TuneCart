...
<body>
            ...
            <div class="row">
                <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                    <div class="image-contain">
                        <img href="{{asset('assets/frontend'}}/images/inner-page/log-in.png" class="img-fluid" alt="">
                    </div>
                </div>
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.google.com/" class="btn google-button w-100">
                                        <img href="{{asset('assets/frontend'}}/images/inner-page/google.png" class="blur-up lazyload"
                                            alt=""> Log In with Google
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.facebook.com/" class="btn google-button w-100">
                                        <img href="{{asset('assets/frontend'}}/images/inner-page/facebook.png" class="blur-up lazyload"
    ...
    <!-- log in section end -->
    <!-- Lazyload Js -->
    <script href="{{asset('assets/frontend'}}/js/lazysizes.min.js"></script>
</body>
